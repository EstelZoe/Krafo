...
export default function AssessmentForgotPassword() {
  const navigate = useNavigate();
  const { forgotPassword, loading, error } = useAssessmentAuth();
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      navigate('/assessment-toolkit/verify-reset-otp', { state: { email } });
