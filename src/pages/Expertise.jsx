          ...
          {EXPERTISE.map((item, i) => {
            ...
            return (
              <motion.article
                key={item.slug}
                id={item.slug}
                className="scroll-mt-28 grid grid-cols-1 lg:grid-cols-2 gap-8 items-start border-b border-gray-800/70 pb-12 md:pb-16 last:border-b-0"
              ...
              >
                ...
                <div>
                  <div className="flex items-center gap-4 mb-4">
                    <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-orange-500/10 border border-orange-500/30 flex items-center justify-center">
